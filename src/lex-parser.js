...
lrtable: {"actions":{"0":{"INCLUSIVE_CONDITION":["shift",3],"EXCLUSIVE_CONDITION":["shift",4]},"1":{"$end":["shift",5]},"2":{"%%":["shift",6]},"3":{"CONDITION":["shift",8]},"4":{"CONDITION":["shift",8]},"5":{"$end":["accept",0]},"6":{"<":["shift",12],"REGEX":["shift",13]},"7":{"%%":["reduce",2],"CONDITION":["shift",14]},"8":{"%%":["reduce",5],"CONDITION":["reduce",5]},"9":{"%%":["reduce",3],"CONDITION":["shift",14]},"10":{"$end":["reduce",1],"<":["shift",12],"REGEX":["shift",13]},"11":{"$end":["reduce",7],"<":["reduce",7],"REGEX":["reduce",7]},"12":{"START_CONDITION":["shift",17]},"13":{"ACTIONBODY":["shift",19],"{":["shift",20]},"14":{"%%":["reduce",4],"CONDITION":["reduce",4]},"15":{"$end":["reduce",6],"<":["reduce",6],"REGEX":["reduce",6]},"16":{">":["shift",21],",":["shift",22]},"17":{",":["reduce",11],">":["reduce",11]},"18":{"$end":["reduce",9],"<":["reduce",9],"REGEX":["reduce",9]},"19":{"$end":["reduce",12],"<":["reduce",12],"REGEX":["reduce",12]},"20":{"ACTIONBODY":["shift",23],"}":["shift",24]},"21":{"REGEX":["shift",25]},"22":{"START_CONDITION":["shift",26]},"23":{"}":["shift",27]},"24":{"$end":["reduce",14],"<":["reduce",14],"REGEX":["reduce",14]},"25":{"ACTIONBODY":["shift",19],"{":["shift",20]},"26":{",":["reduce",10],">":["reduce",10]},"27":{"$end":["reduce",13],"<":["reduce",13],"REGEX":["reduce",13]},"28":{"$end":["reduce",8],"<":["reduce",8],"REGEX":["reduce",8]}},"gotos":{"0":{"lex":1,"definitionlist":2},"3":{"condition_names":7},"4":{"condition_names":9},"6":{"rulelist":10,"rule":11},"10":{"rule":15},"12":{"start_conditions":16},"13":{"action":18},"25":{"action":28}}},
productions: [{"symbol":"$accept","nullable":false,"firsts":["INCLUSIVE_CONDITION","EXCLUSIVE_CONDITION"],"rhs":["lex","$end"],"srhs":"lex $end","id":0,"actionCode":"this.$$ = $1;"},{"symbol":"lex","nullable":false,"firsts":["INCLUSIVE_CONDITION","EXCLUSIVE_CONDITION"],"rhs":["definitionlist","%%","rulelist"],"srhs":"definitionlist %% rulelist","id":1,"actionCode":"this.$$ = {rules: $3}; this.$$.states = {}; if($1.inclusive){this.$$.states.inclusive = $1.inclusive;} if($1.exclusive){this.$$.states.exclusive = $1.exclusive;}"},{"symbol":"definitionlist","nullable":false,"firsts":["INCLUSIVE_CONDITION"],"rhs":["INCLUSIVE_CONDITION","condition_names"],"srhs":"INCLUSIVE_CONDITION condition_names","id":2,"actionCode":"this.$$ = {\"inclusive\":$2};"},{"symbol":"definitionlist","nullable":false,"firsts":["EXCLUSIVE_CONDITION"],"rhs":["EXCLUSIVE_CONDITION","condition_names"],"srhs":"EXCLUSIVE_CONDITION condition_names","id":3,"actionCode":"this.$$ = {\"exclusive\":$2};"},{"symbol":"condition_names","nullable":false,"firsts":["CONDITION"],"rhs":["condition_names","CONDITION"],"srhs":"condition_names CONDITION","id":4,"actionCode":"$1.push($1);this.$$=$1;"},{"symbol":"condition_names","nullable":false,"firsts":["CONDITION"],"rhs":["CONDITION"],"srhs":"CONDITION","id":5,"actionCode":"this.$$ = [$1];"},{"symbol":"rulelist","nullable":false,"firsts":["<","REGEX"],"rhs":["rulelist","rule"],"srhs":"rulelist rule","id":6,"actionCode":"$1.push($2); this.$$ = $1;"},{"symbol":"rulelist","nullable":false,"firsts":["<","REGEX"],"rhs":["rule"],"srhs":"rule","id":7,"actionCode":"this.$$ = [$1]"},{"symbol":"rule","nullable":false,"firsts":["<"],"rhs":["<","start_conditions",">","REGEX","action"],"srhs":"< start_conditions > REGEX action","id":8,"actionCode":"this.$$ = {regex: (new RegExp($4)), action:$5}; if($1){this.$$.conditions=$2} "},{"symbol":"rule","nullable":false,"firsts":["REGEX"],"rhs":["REGEX","action"],"srhs":"REGEX action","id":9,"actionCode":"this.$$ = {regex: (new RegExp($1)), action:$2}; "},{"symbol":"start_conditions","nullable":false,"firsts":["START_CONDITION"],"rhs":["start_conditions",",","START_CONDITION"],"srhs":"start_conditions , START_CONDITION","id":10,"actionCode":"$1.push($3); this.$$ = $1;"},{"symbol":"start_conditions","nullable":false,"firsts":["START_CONDITION"],"rhs":["START_CONDITION"],"srhs":"START_CONDITION","id":11,"actionCode":"this.$$ = [$1];"},{"symbol":"action","nullable":false,"firsts":["ACTIONBODY"],"rhs":["ACTIONBODY"],"srhs":"ACTIONBODY","id":12,"actionCode":"this.$$ = $1"},{"symbol":"action","nullable":false,"firsts":["{"],"rhs":["{","ACTIONBODY","}"],"srhs":"{ ACTIONBODY }","id":13,"actionCode":"this.$$ = $2.replace(/[\\r\\n]/g,\"\")"},{"symbol":"action","nullable":false,"firsts":["{"],"rhs":["{","}"],"srhs":"{ }","id":14,"actionCode":"this.$$ = \"\""}],
