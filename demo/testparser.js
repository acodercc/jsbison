...
states:{"exclusive":{}},
rules: [{regex:/^\d+/,action:'     return "NUMBER";'},{regex:/^\+/,action:'      return "+";'},{regex:/^\*/,action:'      return "*";'},{regex:/^\-/,action:'      return "-";'},{regex:/^\//,action:'      return "/";'},{regex:/^\(/,action:'      return "(";'},{regex:/^\)/,action:'      return ")";'}],
yymore:function (){
            this._more = true;
        },
stateStack:["INITIAL"],
